...
public class DatabaseInitializer {
    ...
    public void init() throws IOException {
        ...
        userService.save(new User("user","paula@gmail.com", passwordEncoder.encode("pass"), rolAdmin,912));
        userService.save(new User("admin","juanjo@gmail.com",passwordEncoder.encode("adminpass"), rolUser,112));
